...
class App:
    ...
    def getState(self):
        return str((self.appleAngle, self.blocked[0], self.blocked[1], self.blocked[2], self.blocked[6], self.blocked[7], self.blocked[8], self.blocked[9], self.snakedir[0], self.snakedir[1]))
